...
::: nonincremental
-   Student-athlete on the diving team
-   Hadn't thought about teaching as a career
-   Majored in mathematics, math lab tutor
-   Service opportunity for student-athletes sparked inspiration to pursue teaching
:::
...
-   Learned how to be succinct, get creative w/ engaging activities
:::
:::
...
::: nonincremental
-   Back to Miami, master's in math to teach at community college
...
![](./img/adult_learn.png){.absolute bottom="0" left="0" width="500" height="280"}

![](./img/duke.jpg){.absolute bottom="0" right="0" width="500" height="280"}
...
-   Innovative pedagogy to make an engaging, inclusive classroom
:::
